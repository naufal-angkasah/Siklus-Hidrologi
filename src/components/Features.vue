...
<template>
  <div id="Features" class="four-expect-area pt-100 pb-70">
    <div class="container">
      ...
      <div style="height: 400px; width: auto" class="overflow-auto zoomInDown">
      ...
      <b-form class="p-3 zoomInUp" @submit="onSubmit" @reset="onReset">
        <div class="cardx p-3 mt-2">
          <div class="pt-10">
            ...
            <div class="mt-2 px-4 flex-column text-right">
              ...
              <b-button type="button" @click="reload" pill variant="info"
                >Reload</b-button
              >
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    reload() {
      setInterval(() => {
        axios
          .get('https://api-kakerol-git-main-fathinafifs-projects.vercel.app/api/v1/komentar')
    ...
    onSubmit() {
      ...
      if (this.postKomentar.komentar !== '') {
        ...
        axios
          .post(
            'https://api-kakerol-git-main-fathinafifs-projects.vercel.app/api/v1/komentar',
            data,
          )
