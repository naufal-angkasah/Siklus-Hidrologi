      ...
      <div class="flipInX">
                ...
                <CCallout color="info">
                  <table class="bold" style="width: 100%">
                    ...
                    <tr>
                      <td>NAMA GURU</td>
                      <td>:</td>
                      <td>Nuridha, S.Pd. & Jalaluddin, S.Pd.</td>
                    </tr>
                    <tr>
                      <td>SEKOLAH</td>
                      <td>:</td>
            ...
            <b-tab title="Glosarium & Daftar Pustaka"
              ...
              <div class="card2">
                ...
                >
                  ...
                  <p>
                    Nejc, Bezak., Mojca, Šraj., Katarina, Zabret., Matteo, Moro.
                    (2023). Monitoring of soil moisture response as part of the
                    ecohydrological cycle. doi: 10.5194/egusphere-egu23-8643
                  </p>
                </CCallout>
              </div>
            </b-tab>
        ...
        <div class="text-center">
          <b-button-group class="mt-2">
            <b-button pill variant="info" @click="tabIndex--"
              >Previous</b-button
            >
            <b-button pill variant="info" @click="tabIndex++">Next</b-button>
          </b-button-group>
        </div>
      </div>
    </div>
