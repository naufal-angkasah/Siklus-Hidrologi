...
export default {
  ...
  methods: {
    ...
    async addData() {
      ...
      console.log(datas)
      axios
        .post(`https://api-kakerol-git-main-fathinafifs-projects.vercel.app/api/v1/jawabanSpritual`, datas)
        .then((response) => console.log("berhasil:",response.data))
        .catch((error) => {return console.log('Gagal : ', error)})
        //modif atribut user
      axios.put(`https://api-kakerol-git-main-fathinafifs-projects.vercel.app/api/v1/user/${id_user}`, 
        { 
          isPosttest: true 
        }
      )
      .then((response) => console.log("berhasil:",response.data))
        .catch((error) => {return console.log('user Gagal : ', error)})
