              ...
              <div class="radio-list" style="font-size: 10px">
                ...
                >
                  ...
                  <div class="">
                    ...
                    <p style="font-size: 20px">{{ index + 1 }}. {{ k.pertanyaan }}</p>
                    <ul >
                      <li
                      ...
                      >
                        ...
                        />
                        <label style="font-size: 20px" class="form-check-label justify-content-start" :for="response.id + k.pertanyaan"
...
export default {
  ...
  _methods: {
    ...
    async addData() {
      ...
      await axios
        .post(`https://api-kakerol-git-main-fathinafifs-projects.vercel.app/api/v1/jawabanKognitif/`, datas)
        .then((response) => {
