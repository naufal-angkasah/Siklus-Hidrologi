                ...
                >
                  ...
                  <ul>
                    ...
                    >
                      ...
                      <label
                        ...
                        :for="response.id + ppl.pernyataan"
                  ...
                  <div class="col d-flex justify-content-between">
                    <div
                      ...
                      class="d-flex justify-content-sm-end pt-4"
                    >
                      <CButton
                        color="success"
                        class="btn-lg"
...
export default {
  ...
  methods: {
    async addData(no, jawaban) {
      ...
      await axios
        .post(
          `https://api-kakerol-git-main-fathinafifs-projects.vercel.app/api/v1/jawabanPPL/`,
          datas,
        )
