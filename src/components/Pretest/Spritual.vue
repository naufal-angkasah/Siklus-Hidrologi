    ...
    <div class="row p-2">
      <section class="radio-section overflow-auto">
        <div class="px-2">
              ...
              <tr v-for="(field, index) in data" :key="index">
                ...
                <td>
                  <input
                    ...
                    type="radio"
                    :id="field.angket + index + '1'"
                    value="1"
                    v-model="field.value"
                  />
                  <label
                    class="form-check-label"
                    :for="field.angket + index + '1'"
                  ></label>
                </td>
                <td>
                  <input
                    class="form-check-input"
                    type="radio"
                    :id="field.angket + index + '2'"
                    value="2"
                    v-model="field.value"
                  />
                  <label
                    class="form-check-label"
                    :for="field.angket + index + '2'"
                  ></label
                  ><br />
                </td>
                <td>
                  <input
                    class="form-check-input"
                    type="radio"
                    :id="field.angket + index + '3'"
                    value="3"
                    v-model="field.value"
                  />
                  <label
                    class="form-check-label"
                    :for="field.angket + index + '3'"
                  ></label
                  ><br />
                </td>
                <td>
                  <input
                    class="form-check-input"
                    type="radio"
                    :id="field.angket + index + '4'"
                    value="4"
                    v-model="field.value"
                  />
                  <label
                    class="form-check-label"
                    :for="field.angket + index + '4'"
                  ></label
                  ><br />
                </td>
                <td>
                  <input
                    class="form-check-input"
                    type="radio"
                    :id="field.angket + index + '5'"
                    value="5"
                    v-model="field.value"
                  />
                  <label
                    class="form-check-label"
                    :for="field.angket + index + '5'"
                  ></label
                  ><br />
                </td>
                <td>
                  <input
                    class="form-check-input"
                    type="radio"
                    :id="field.angket + index + '6'"
                    value="6"
                    v-model="field.value"
                  />
                  <label
                    class="form-check-label"
                    :for="field.angket + index + '6'"
                  ></label
                  ><br />
                </td>
                <td>
                  <input
                    class="form-check-input"
                    type="radio"
                    :id="field.angket + index + '7'"
                    value="7"
                    v-model="field.value"
                  />
                  <label
                    class="form-check-label"
                    :for="field.angket + index + '7'"
                  ></label
                  ><br />
                </td>
                <td>
                  <input
                    class="form-check-input"
                    type="radio"
                    :id="field.angket + index + '8'"
                    value="8"
                    v-model="field.value"
                  />
                  <label
                    class="form-check-label"
                    :for="field.angket + index + '8'"
                  ></label
                  ><br />
                </td>
                <td>
                  <input
                    class="form-check-input"
                    type="radio"
                    :id="field.angket + index + '9'"
                    value="9"
                    v-model="field.value"
                  />
                  <label
                    class="form-check-label"
                    :for="field.angket + index + '9'"
                  ></label
                  ><br />
                </td>
                <td>
                  <input
                    class="form-check-input"
                    type="radio"
                    :id="field.angket + index + '10'"
                    value="10"
                    v-model="field.value"
                  />
                  <label
                    class="form-check-label"
                    :for="field.angket + index + '10'"
                  ></label
                  ><br />
                </td>
              </tr>
          ...
          <button type="button" @click="fillJawaban" class="btn btn-success">
            Submit
          </button>
          <!-- <div>
            {{ this.error }}
...
export default {
  ...
  methods: {
      ...
      for (let i = 0; i < this.data.length; i++) {
        if (this.data[i].value == '') {
          this.error.push(
            'Angket no  ' +
              (i + 1) +
              ' belum anda isi, silahkan isi terlebih dahulu',
          )
    ...
    async addData() {
      ...
      axios
        .post(
          `https://api-kakerol-git-main-fathinafifs-projects.vercel.app/api/v1/jawabanSpritual`,
          datas,
        )
      ...
      axios
        .put(
          `https://api-kakerol-git-main-fathinafifs-projects.vercel.app/api/v1/user/${id_user}`,
          {
            isPretest: true,
          },
        )
        .then((response) => console.log('berhasil:', response.data))
        .catch((error) => {
          return console.log('user Gagal : ', error)
        })
