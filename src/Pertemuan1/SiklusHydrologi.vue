      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <table class="bold" style="width: 100%">
            ...
            <tr>
              <td>⮚ Kembali lagi dalam bentuk Air permukaan</td>
              <td>• Koleksi</td>
            </tr>
          </table>
          <br />
          ...
          <br /><br />
          <!-- <h6>Ilustrasi Siklus Hidrologi</h6> -->
          <center>
            <div>
              <video class="vid2" play controls loop width="300" id="myVideo">
                <source
                  src="@/assets/video/SiklusHidrologi.mp4"
                  type="video/mp4"
                />
          ...
          <center>
            ...
            <h6>
              ...
              <a href="https://www.bing.com/images/create" target="_blank">
                AI Bing.com </a
              >&
              <a href="https://app.runwayml.com/video-tools/" target="_blank">
                AI Runway</a
              >
              )
            </h6>
        ...
        <CCardBody>
          ...
          <center>
            <div>
              <video class="vid2" play controls loop width="300" id="myVideo">
                <source
                  src="@/assets/video/Kondensasiawan.mp4"
                  type="video/mp4"
                />
                Your browser does not support HTML5 video.
              </video>
            ...
            <h6>
              ...
              <a
                href="https://www.youtube.com/watch?v=nP02YF8_c2E"
                target="_blank"
              >
                Youtube chrvoje_engineering </a
              >&
              <a
                href="https://www.youtube.com/watch?v=kWlrcABJTbY"
                target="_blank"
              >
                Youtube Danny</a
              >
        ...
        <CCardBody>
          ...
          <center>
            ...
            <h6>
              Sumber : Modifikasi dari
              <a
                href="https://www.youtube.com/watch?v=qZQiwlCs18M"
                target="_blank"
              >
                Youtube Conscious Planet
              </a>
            </h6>
          </center>
        </CCardBody>
