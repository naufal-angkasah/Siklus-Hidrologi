        ...
        <CCardBody>
          ...
          <CAccordion>
            ...
            <div>
              ...
              <!-- <p>(+ Slide Video (3 video)) video cek di grup wa</p> -->
              <!-- <p>Ilustrasi hujan dan tanaman tumbuh :</p> -->
              <center>
                <div>
                  <video
                    class="vid2"
                  ...
                  >
                    <source
                      src="@/assets/video/Hujanntanaman.mp4"
                      type="video/mp4"
                    />
                ...
                <h6>
                  ...
                  >&
                  <a
                    href="https://app.runwayml.com/video-tools/"
                    target="_blank"
                  >
                    AI Runway</a
                  >
...
<script>
import yt from '@/components/ytmanfaathujan.vue'
import { ref } from 'vue'
export default {
  name: 'Collapse',
  components: {
